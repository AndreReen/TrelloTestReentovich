...
public class TrelloBoardFull {
    ...
    public String toString() {
        ...
        sb.append(TrelloBoardFull.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrelloBoardFull) == false) {
            return false;
        }
        TrelloBoardFull rhs = ((TrelloBoardFull) other);
