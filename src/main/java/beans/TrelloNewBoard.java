...
public class TrelloNewBoard {
    ...
    public String toString() {
        ...
        sb.append(TrelloNewBoard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TrelloNewBoard) == false) {
            return false;
        }
        TrelloNewBoard rhs = ((TrelloNewBoard) other);
